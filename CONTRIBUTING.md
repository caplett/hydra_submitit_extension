...
Welcome to `hydra_submitit_extension` contributor's guide.
...
If you experience bugs or general issues with `hydra_submitit_extension`, please have a look
...
You can help improve `hydra_submitit_extension` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`hydra_submitit_extension` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `hydra_submitit_extension`'s files. While this mechanism can
...
```
conda create -n hydra_submitit_extension python=3 six virtualenv pytest pytest-cov
conda activate hydra_submitit_extension
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/hydra_submitit_extension.git
   cd hydra_submitit_extension
   ```
...
5. Install [pre-commit]:
   ...
   `hydra_submitit_extension` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/hydra_submitit_extension
[issue tracker]: https://github.com/<USERNAME>/hydra_submitit_extension/issues
